...
var withHour = document.getElementById('withHours');
var withOutHour = document.getElementById('withOutHours');
...
function timeFormat() {
    var getWithHours = withHour.value;
    var getWithOutHours = withOutHour.value;
}
