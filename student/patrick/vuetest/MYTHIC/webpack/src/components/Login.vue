...
<div class="LogInPageGridContainer">
    <div id="LoginGridOne" class="LoginGridOne"></div>
            ...
            <tr>
                ...
                <td><input v-bind="Username" type="text" /></td>
            </tr>
            <tr>
                <td><div>Password: </div></td>
                <td><input v-bind="Password" @keydown.enter="LoginCheck" type="password" /></td>
            </tr>
            </table>
            
            <button class="TableButton" @click="LoginCheck">Login</button><br/>
            <button class="TableButton" @click="$router.push('@/components/NewAccount')">New Account</button><br/>
            ...
            db.collection("Users")
                ...
                .then(function (querySnapshot)
                {
                    if (querySnapshot.size > 0) {
                        ...
                        this.ThisUser = querySnapshot.docs[0].data();
                        alert("Welcome " + this.ThisUser.Username);
                        $router.push('@/components/Swipe');
                    }
                    else {
