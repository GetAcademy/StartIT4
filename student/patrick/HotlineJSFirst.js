...
var ScreensWidth = screen.availWidth;
var ScreensHeight = screen.availHeight;
    
function MakeToolbarSize()
{
    //document.getElementById("Toolbar").style.width = 100 + 'vw';
    //document.getElementById("Toolbar").style.height = 6.25 + 'vh';
    //document.getElementById("HotlineHead").style.fontSize = 3.5 + 'vmin';
    //document.getElementById("Triangle").style.fontSize = 7 + 'vmin';
}
